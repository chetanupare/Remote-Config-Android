...
public class MainActivity extends AppCompatActivity {
    // Remote Config keys
    private static final String CONFIG_KEY_PRICE = "nike_price";
    private static final String CONFIG_KEY_REBOOK_PRICE ="rebook_price";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPriceTextView2 = findViewById(R.id.txt1);
    ...
    private void displayPrice() {
        ...
        long initialPrice2 = mFirebaseRemoteConfig.getLong(CONFIG_KEY_REBOOK_PRICE);
        long finalPrice = initialPrice;
        long finalPrice2 = initialPrice2;
        ...
        if (mFirebaseRemoteConfig.getBoolean(CONFIG_KEY_IS_PROMOTION)) {
            ...
            finalPrice2 = initialPrice2 - mFirebaseRemoteConfig.getLong(CONFIG_KEY_DISCOUNT);
        }
        mPriceTextView.setText(getString(R.string.price_prefix, finalPrice + ""));
        mPriceTextView2.setText(getString(R.string.price_prefix, finalPrice2 + ""));
       ;
    }
}